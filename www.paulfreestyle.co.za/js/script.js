    ...
    image.addEventListener("load", function () {
        ...
        window.onscroll = () => {
            if (window.scrollY > 390) {
                ...
                if (dominantColor[0] < 40 && dominantColor[1] < 40 && dominantColor[2] < 40) header.style.backgroundColor = 'rgb(50 118 168)';
                headerBtn.classList.add('active');
                headerOverlay.style.backgroundColor = 'rgb(0 0 0 / 0.45)';
            } else if (window.scrollY < 390 && dominantColor[0] < 40 && dominantColor[1] < 40 && dominantColor[2] < 40) {
                    header.style.backgroundColor = 'rgb(50 118 168 / 0.5)';
