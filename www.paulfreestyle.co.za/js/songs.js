const musicArray = [
  ...
  },
  {
    ...
    artist: "2pac",
    lyrics: `I won't deny it, I'm a straight ridah
...
`,
    artistImg: "2pac.jpeg",
    img: "all-eyez-on-me.jpeg",
    source: "ambitionz.mp3",
    ft: "",
  },
  {
...
Sugar, sugar`,
  ...
  },
  {
    ...
    On my tour bus
    We get dumb high you's a floorboard
    Fredo got a hangover he totin' a Cobra
    Last night he was shootin' shit up like O-Dog
    Reese rollin', Tadoe got hoes on mollies
    Chief Sosa, Ballout, we high riding 'Rari's
    ...
    All these bitches off these shits, walking 'round like some zombies
    Call up D-Money, now we throw money
    All these bitches off these shits, walking 'round like some zombies
    Damn I hate being sober, I'm a smoker
    Fredo a drinker, Tadoe off molly water
    ...
    Watch me roll up
    'Cause I can't spell sober
    Uh, my weed so strong, my cheese so long
  ...
  },
  {
    ...
    You can let them ride off to the sunset, I'm a sunrise
    ...
    I did it just for you
    And you just don't care
    Mmh this could be a Cinderella story for a fella
    ...
    Show me love when you're ready 'til then I'll be chillin'
    Speak 'cause you know I can't read minds
    Can't spend more time unless I rewind
    Gotta wait for the stars to realign
    You said, "It's all about time"
    Well, I just got signed (ayy)
    ...
    Procrastinatin', start appreciatin' it's not too late and
    I did it just for you
    I did it just for you
    I did it just for you
    And you just don't care
  ...
  },
  {
    ...
    And I'ma drop it on your fuckin' head (haha)
    Yeah, bitch, I'ma pick the world up
    And I'ma drop it on your fuckin' head
    Yeah, and I could die now, rebirth, motherfucker
    Hop up in my spaceship and leave Earth, motherfucker
    ...
    Boy, this crooked mind of mine got 'em
    All shook and scared to look in my eyes
    ...
    This stage is my pedestal, I'm an unstoppable
  ...
  },
  {
    ...
    I'm still coming for youI can hear your whisper
  ...
  },
  {
    ...
    The handle and wait for the fist to fly off to put this guy in a pine box
  ...
  },
  {
    ...
    Vibe है, vibe है
    थोड़ा सा side दे, छोकरे सब hard
    इसलिए तो hype है, hype है, hype है
    You know I got that vibe
    Vibe है, vibe है
    थोड़ा सा side दे, लड़के सब psych हैं
    छोकरे सब hard
    इसलिए तो hype है, hype है, hype है
    You know I got that vibe
    Vibe है, vibe है
    ...
    इसलिए तो hype है, hype है, hype है
    Ah, hard है ना, छोटे?
    तू softy, कोफ़्ता, भौंकता, मुझे ना रोकता
    पकड़ ले, छोटे (पकड़ ले)
    देख गली का छोकरा बना दे quick से rockstar
    बस है ना, छोटे
    Uh, खौफ़ है ना, छोटे
    सिर्फ़ काटे हम, भौंकें ना, छोटे
    कीलें लगा दे, तू रोक ले
    चमका के रस्ते पे सीधा हम walking लें, छोटे
    ਪੰਗਾ ਨਾ ਲੈ ਤੂੰ, ਨਾਲ ਮੇਰੇ ਸਾਰੇ ਖਤਰਨਾਕ ਵੇ
    ਰਹਿ ਥੋੜ੍ਹਾ ਬੱਚ ਕੇ, ਹੌਲੀ-ਹੌਲੀ ਗਿੱਧਾ ਪਾਉਂਦੇ ਖਲਾਰੇ ਦੇ
    ਸ਼ਕਲ ਤੋਂ ਸਿੱਧਾ-ਸਾਦਾ ਜਿਹਾ ਲੱਗਦਾ, ਪਰ ਹਰਾਮੀ ਵੀ ਬਹੁਤ ਮੈਂਗਾਣੇ ਦੇ ਜ਼ਰੀਏ ਸੱਭ ਨੂੰ ਹਰ ਵਾਰੀ ਆਪਾਂ ਦੇ ਦਿੰਦੇ shot ਵੇ
    अपना ही अलग ही vibe है, अपना ही अलग ही zone है
    जगत ये पूछे कि कौन है
    लफ़्ज़ों की गोली सीधा, बेटा, ठोकते
    Game अपना, इसमें पड़ते चौके-छक्के
    काम तमाम होगा बेशक बे, "Gang अपना hard"
    बोलूँ छाती ठोक के, बोलूँ छाती ठोक के
    तू बस भौंक बे (भौंक)
    You know I got that vibe
    Vibe है, vibe है
    थोड़ा सा side दे, छोकरे सब hard
    ...
    छोकरे सब hard
    इसलिए तो hype है, hype है, hype है
    Vibe है ये Mumbai का, चलो लेके साथ
    आयी Gully Gang, आयी लेके नशीला पदार्थ
    बड़ी हलचल, हर जगह बँटती खैरात
    ठग से बोलते आज इतिहास-इतिहास
    So ये सुनने का नहीं तेरा मन होगा आज
    करते-करते मस्ती बना देते आग
    तो हिलाते जा सर को, अब रुकना नहीं है
    ये ज़हरीला flow जो ना लेने दे साँस
    अपने गर्दन पे hicky, तेरे गर्दन पे knife है
    सहारा जब माँगों तो Slice है, ऐसी ही life है
    Hard अपने boys है, पूछ ले
    Mumbai में अपना ही noise है
    अपनी जो voice है, धुरंधरों की वो choice है
    बोले तो vibe है (है ना?)
    बोले तो vibe है
    देख, आख़िर के vibe में पीछे की wicket है
    Mumbai के vibe में local की ticket है
    उमर से फ़रक क्या? बातें घसीटें
    जो लिखा है, आना है उतना नसीब में
    सारे बस ढीठ हैं, सारे बस ढीठ हैं
    Sick मेरा beat है
    ज़िंदगी रीत है, ज़िंदगी cheat है
    आँखें नशीली, निशाने सटीक हैं (क्या?)
    Big Billy rude boy vibe
    Pain in my head with a pina colada
    Lot of you good girls went south like Colaba
    Cap on my head, but you love the bandana
    My ex don't exist like Wakanda
    Four triple 0 five 0, only want beef in my momos
    Slow like bae, got a two-chip code
    Catch me in the kitchen like Sanjeev Kapoor
    Why?
    'Cause you know I got that vibe
    Vibe है, vibe है
    थोड़ा सा side दे, छोकरे सब hard
    इसलिए तो hype है, hype है, hype है
    You know I got that vibe
  ...
  },
  {
    ...
    It's funny how they compare me to niggas
    Who've hit their pinnacle
    ...
    Hip hop used to drop bars and now we just dance
    It's now or never, never
    It's time to change the game
    Whatever happended to clever rappin
    The heads is askin'
    Now instead of passion, the level is trash to get
    The cash in
    The question I'm asking: Did it die with the
    Veterans back then?
    Or does it live residing inside irrelevant has been
    Like the Proverb dude, but I know the truth
    That's why I jump in a vocal booth
    To show to you how to mould the truth into
    Multiple quotable
    Put soul in the booth
    Using flow as a tool
    Heads enrol in my school
    I show and I prove
    Just how the oldest do, they still the coldest too
    (Damn)
    ...
    And the level is higher once the DJ Switch to
    Ganja Beats
    ...
    Then we should build a bonfire of all their tracks
    And burn 'em up
    It's now or never, never
    It's time to change the game, game
    Man, what happened to rap (Ga'ahd Body)
    Man, what happened to rap
    Forget a now or never it's now or forever,
    Forever and ever
    They feel the presence every year like the
    Month of December
    To make sure you don't forget
    I got much to remember
    Only because I give a F like I'm Juju Malema
    To you who enter with new perceptions choose
    Your dilemas
    Do what you do how you do it or do what the
    Rest does
    Either way, know you're going toe to toe with
    The Kwestas, the Xs
    And that's just you keeping up with the
    Kardashians
    The birth of greatness so feel the contractions
    Exceeded all expectations by a certain
    Percentage
    ...
    Then we'll all be one and the same like Euphonik
    And Themba
    The difference is I'm driven 'cause I know it's
    Now or never
    It's now or never, never
    It's time to change the game, game
    ...
    The guy to dethrone
    Still I'm a king though
    I'm key, bored niggas come around just to c-
    Notes
    I eat off words B
    Your crumbs don't serve me
    You all tweet like birdies
    Your thumbs don't scare me
    So please you all better be done, early
    Or else I put a hole in one, Ernie
    So bang bang or buck buck
    There's a Reason why my Proverbs stay high as
    Eagle
    Ya ngum phetha
